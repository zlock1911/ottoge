...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    event.create('mega_fusion_reactor', 'multiblock', (holder) => new $FusionReactorMachine(holder, GTValues.UHV))
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle("                                 ", "C  N C        AAAAA        C N  C", "ATT#H#H C    CAAAAAC    C H#H#TTA", "ATT#H#H CS  XCAGGGACX  SC H#H#TTA", "ATT#H#H CS  XCAGGGACX  SC H#H#TTA", "ATT#H#H C    CAAAAAC    C H#H#TTA", "C  N C        AAAAA        C N  C", "                                 ")
            ...
            .aisle("C  N C                     C N  C", "ATT#H#H CS  XCAAAAACX  SC H#H#TTA", "A######H#CAAC#######CAAC#H######A", "G###############################G", "G###############################G", "A######H#CAAC#######CAAC#H######A", "ATT#H#H CS  XCAAAAACX  SC H#H#TTA", "C  N C                     C N  C")
            .aisle("C  N C                     C N  C", "ATT#H#H CS  XCAAAAACX  SC H#H#TTA", "A######H#CAAC#######CAAC#H######A", "G###############################G", "G###############################G", "A######H#CAAC#######CAAC#H######A", "ATT#H#H CS  XCAAAAACX  SC H#H#TTA", "C  N C                     C N  C")
            .aisle("C  N C                     C N  C", "ATT#HC  C    CAAAAAC    C  CH#TTA", "A#####H C    C#####C    C H#####A", "A#####HH#CAACC#####CCAAC#HH#####A", "A#####HH#CAACC#####CCAAC#HH#####A", "A#####H C    C#####C    C H#####A", "ATT#HC  C    CAAAAAC    C  CH#TTA", "C  N C                     C N  C")
            .aisle("                                 ", "C  N C        AAAAA        C N  C", "ATT#H#H C    CAAMAAC    C H#H#TTA", "ATT#H#H CS  XCAGGGACX  SC H#H#TTA", "ATT#H#H CS  XCAGGGACX  SC H#H#TTA", "ATT#H#H C    CAAAAAC    C H#H#TTA", "C  N C        AAAAA        C N  C", "                                 ")
            .aisle("                                 ", "                                 ", "C  N C                     C N  C", "C  N C                     C N  C", "C  N C                     C N  C", "C  N C                     C N  C", "                                 ", "                                 ")
            .where('M', Predicates.controller(Predicates.blocks(definition.get())))
            .where('H', Predicates.blocks("gtceu:fusion_coil"))
            .where('T', Predicates.blocks('otto:neutron_coil_block'))
            .where('N', Predicates.blocks('avaritia:neutron'))
            .where('C', Predicates.blocks("gtceu:fusion_casing_mk3"))
            .where('G', Predicates.blocks("gtceu:fusion_glass"))
            .where('S', Predicates.blocks('allthemodium:unobtainium_block'))
            .where('X', Predicates.blocks('allthemodium:vibranium_block'))
